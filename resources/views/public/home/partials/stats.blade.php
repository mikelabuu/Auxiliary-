...
<section class="border-b border-ink/10 px-6" data-fx-card>
    <div class="mx-auto grid max-w-6xl grid-cols-2 md:grid-cols-4 md:divide-x md:divide-ink/10" data-aos="fade-up">
