...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div>
        ...
        <input type="text" name="first_name" value="{{ old('first_name') }}" class="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 text-ink text-sm placeholder:text-ink/35 focus:bg-white/10 focus:border-gold/60 focus:ring-2 focus:ring-gold/20 outline-none transition-[color,background-color,border-color,box-shadow] font-semibold" required>
    </div>
    <div>
        <label class="block text-xs font-bold text-ink/60 tracking-wider uppercase mb-1.5">Middle Name</label>
        <input type="text" name="middle_name" value="{{ old('middle_name') }}" class="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 text-ink text-sm placeholder:text-ink/35 focus:bg-white/10 focus:border-gold/60 focus:ring-2 focus:ring-gold/20 outline-none transition-[color,background-color,border-color,box-shadow] font-semibold">
    </div>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
    <div>
        ...
        <input type="text" name="last_name" value="{{ old('last_name') }}" class="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 text-ink text-sm placeholder:text-ink/35 focus:bg-white/10 focus:border-gold/60 focus:ring-2 focus:ring-gold/20 outline-none transition-[color,background-color,border-color,box-shadow] font-semibold" required>
    </div>
    <div>
        ...
        <input type="text" name="suffix" value="{{ old('suffix') }}" class="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 text-ink text-sm placeholder:text-ink/35 focus:bg-white/10 focus:border-gold/60 focus:ring-2 focus:ring-gold/20 outline-none transition-[color,background-color,border-color,box-shadow] font-semibold">
    </div>
</div>
...
<div class="mt-4">
    ...
    <div class="relative flex items-center">
        ...
        <input type="tel" name="guest_phone" id="guest_phone" value="{{ old('guest_phone') }}" class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-white/10 bg-white/5 text-ink text-sm placeholder:text-ink/35 focus:bg-white/10 focus:border-gold/60 focus:ring-2 focus:ring-gold/20 outline-none transition-[color,background-color,border-color,box-shadow] font-semibold"
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-5 mt-5 border-t border-white/10 items-center">
    <div>
        ...
        <div class="stepper flex items-center gap-2">
            <button type="button" class="btn-step w-10 h-10 rounded-xl border border-white/12 bg-white/5 flex items-center justify-center text-ink/70 hover:bg-white/10 hover:border-gold/50 hover:text-ink active:scale-95 transition-[transform,color,background-color,border-color,box-shadow] cursor-pointer shrink-0" data-step="-1" aria-label="Fewer guests">
                <span class="material-icons text-[18px]">remove</span>
            </button>
            <input type="number" id="expected_guests" name="expected_guests" value="{{ old('expected_guests', 1) }}" class="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 text-ink text-sm text-center focus:bg-white/10 focus:border-gold/60 focus:ring-2 focus:ring-gold/20 outline-none transition-[color,background-color,border-color,box-shadow] font-bold [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none" min="1" max="40" required>
            <button type="button" class="btn-step w-10 h-10 rounded-xl border border-white/12 bg-white/5 flex items-center justify-center text-ink/70 hover:bg-white/10 hover:border-gold/50 hover:text-ink active:scale-95 transition-[transform,color,background-color,border-color,box-shadow] cursor-pointer shrink-0" data-step="1" aria-label="More guests">
...
<div class="pt-5 mt-5 border-t border-white/10 flex items-start gap-2.5">
    <input type="checkbox" id="request_discount" name="request_discount" class="w-4.5 h-4.5 mt-0.5 rounded-md border-white/25 bg-white/5 text-gold focus:ring-gold focus:ring-2 cursor-pointer transition-[color,background-color,border-color,box-shadow]" value="1">
