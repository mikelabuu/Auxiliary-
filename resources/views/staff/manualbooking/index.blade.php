...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderBoard() {
        ...
        if (!state.rooms.length) {
            board.innerHTML = '<p class="rounded-2xl border border-dashed border-emerald-deep/20 bg-white/50 px-5 py-6 text-center text-sm font-medium text-stone-400">No rooms found. Add rooms in Room Management first.</p>';
            return;
        }
        let html = '';
        groups.forEach((rooms, slug) => {
