            ...
            <div class="px-8 pb-10">
                <div>
                    <div class="text-center mb-8">
                        <h2 class="text-3xl font-extrabold text-slate-900 leading-tight mt-4">Email Verification Required</h2>
                        <p class="text-slate-600 mt-2">Thanks for signing up! Before accessing the site, please check your email for a verification link.</p>
                        @if ($errors->any())
                    ...
                    <form class="space-y-4" method="POST" action="{{ route('verification.send') }}">
                        @csrf
                        <p class="text-slate-600 mt-2">Didn't Receive a link? Click to verify again.</p>
