<div class="{{ $theme === 'bootstrap' ? '' : 'grid grid-cols-1 sm:grid-cols-2 gap-4' }}">
    <div class="{{ $theme === 'bootstrap' ? 'mb-3' : '' }}">
        ...
        <select wire:model.live="selectedRegion" class="{{ $theme === 'bootstrap' ? 'form-select' : 'w-full px-4 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-clsu-500/25 focus:border-clsu-500 transition-colors cursor-pointer' }}" name="region_code" autocomplete="address-level1" required>
    ...
    <div class="{{ $theme === 'bootstrap' ? 'mb-3' : '' }}">
        ...
        <select wire:model.live="selectedProvince" class="{{ $theme === 'bootstrap' ? 'form-select' : 'w-full px-4 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-clsu-500/25 focus:border-clsu-500 transition-colors cursor-pointer' }}" name="province_code" autocomplete="address-level1">
    ...
    <div class="{{ $theme === 'bootstrap' ? 'mb-3' : '' }}">
        ...
        <select wire:model.live="selectedCity" class="{{ $theme === 'bootstrap' ? 'form-select' : 'w-full px-4 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-clsu-500/25 focus:border-clsu-500 transition-colors cursor-pointer' }}" name="city_code" autocomplete="address-level2" required>
    ...
    <div class="{{ $theme === 'bootstrap' ? 'mb-3' : '' }}">
        ...
        <select wire:model.live="selectedBarangay" name="barangay_code" class="{{ $theme === 'bootstrap' ? 'form-select' : 'w-full px-4 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-clsu-500/25 focus:border-clsu-500 transition-colors cursor-pointer' }}" autocomplete="address-level3" required>
