...
@php
// Inline lucide icon paths — stroke style is part of the boutique aesthetic.
$icons = [
...
// Legacy material-icon names still used in config/room_types.php amenities
$aliases = [
    'shower'      => 'droplets',
    'inventory_2' => 'package',
...
$resolved = $icons[$name] ?? $icons[$aliases[$name] ?? ''] ?? $icons['check'];
@endphp

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" {{ $attributes }}>{!! $resolved !!}</svg>
