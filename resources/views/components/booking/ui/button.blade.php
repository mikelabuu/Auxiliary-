...
@php
    $baseStyles = "inline-flex items-center justify-center gap-1.5 px-5 py-2.5 rounded-full text-sm font-bold tracking-wide transition-[color,background-color,border-color,box-shadow] duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 select-none cursor-pointer";
