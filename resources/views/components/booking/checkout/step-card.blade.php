...
<div {{ $attributes->merge(['class' => 'bg-cream-warm rounded-3xl p-6 sm:p-8 ring-1 ring-emerald-deep/5 shadow-[0_14px_34px_-26px_rgba(6,40,30,0.3)]']) }}>
    <div class="flex items-center justify-between gap-3 mb-5">
        <div class="flex items-center gap-2.5">
            <span class="w-8 h-8 rounded-xl bg-gold/10 text-palay-800 ring-1 ring-gold/25 flex items-center justify-center shrink-0"><span class="material-icons text-[18px]">{{ $icon }}</span></span>
            <div>
